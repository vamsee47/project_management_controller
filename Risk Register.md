...
R06| 6 | Identical Applications | Their might has a existing application availbale in the market .So Maintain a wide varitey of application  | Market Risk | Existing Identical applications | Applications | Risk Acceptance | Program manager | Medium | High | Mitigated| 
