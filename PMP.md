...
2 | **Roles & Responsibilities** | Project Manager - Vamsee Krishna Gangapatnam - accede to or reject the tasks <br> Team Lead - Sai Manikanta Durga prasad vinukonda -Accumulate and analyses the Market & Financial Risks <br> Web Developer - Venkata Dasari - collects and study the technology and structural/process RisK <br> UI Developer - Vamsee Krishan Gangapatnam,Aakash Vulluru - Studys the resource risk |
3 | **Budget & Schedule** |A gantt charts are used to know the schedule of the team and work done by the team in a particular day or week  and also their should be main focus on a budget. So, if any irregularities are seen then immediate action is taken.|
4 | **Risk Categories** | The risks are mainly categorized as: <br>  External Risk:   Occurs due to enviromental issues <br>  Organizational Risks: It occurs due  to poor prioritization of projects. <br> Management risks: It  Occurs when there is a poor allocation of schedule and time. <br> Technical Risks:Occurs on system, project, or on entire infrastructure when an implementation doesn't work.. |
5 | **Risk probability and impact** | These are rated from low to high .It effects  Quadruple Constraints that is  cost, time,scope, quality of the project. |
...
---|---|---|---|---|---|---|---|---|---|---------------|----------------|
R01| 1 | Initial  Extra CostPlanning Budget Fail| In the project budget is a critical role. It was difficult to maintain the project budget consistent .If there is any changes in the prices then budget also changes .Ex(Office Maintenance ,Software Tools)| Financial | Improper planning of the employee on Budget| Rise in Budget | Risk  Avoidance  | Operational Manager | High| High | Prediction |
R02| 2 | Identical Applications | Their might has a existing application availbale in the market .So Maintain a wide varitey of application  | Market Risk | Existing Identical applications | Applications | Risk Acceptance | Program manager | Medium | High | Mitigated| 
...
R04| 4 | Employee Technical skills |Lack of Technical Skills of the employee| Technical Risk |Lack of knowledge on project | poor deliverables | Risk Acceptance | Program Manager | High | High | Prediction |
...
|------------------|-------------------|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| Vamsee Krishna Gangapatnam     | High              | Leading            | Vamsee Has smart Management Skills, Leadership quality. Managed the project communicate with client and acts as a catalyst & bridge among team and client. Analyzing every task and its implementation.                                                                    | 
| Sai Manikanta Durga Prasad Vinukonda    | High              | Supportive         |  Prasad He has good commanding skills and good at Coding He can monitor the project status                                                                                                                                                                          | 
| Venkata krishna Dasari   | High              | Supportive         | Venkat has the flexibility to be unitedly with the core business units and also the data Services Department to translate user requirements, develop and coordinate user testing, | 
| Aakash Vulluru     | High              | Testing            | Has Good Analyzing skills and finding the root cause skills.                                                                                                                           | 
#### Issue log
